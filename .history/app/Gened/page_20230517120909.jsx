...
<main className={styles.main}>
    ...
    <form>
      ...
      <div className="form-check">
          ...
          <label class="form-check-label" htmlFor="comm">  COMM 101: Oral Communication</label>
      </div>
      <p> Section 1B: Written Communication </p>
      <div className="form-check">
          <input type="radio" class="form-check-input" id="eng1" name="s1B"/>
          <label class="form-check-label" htmlFor="eng1"> ENG 100: College English Composition </label>
      </div>
      <p> Section 1C: Critical Thinking and Reading Skills </p>
      <div className="form-check">
          <input type="radio"class="form-check-input" id="eng2" name="s1C"/>
          <label class="form-check-label" htmlFor="eng2"> ENG 200: Reading and Analysis </label>
      </div>
      <p> Section 2A: Numerical Skills </p>
      <div className="form-check">
          <input type="radio" class="form-check-input" id="math1"name="s2A"/>
          <label class="form-check-label"htmlFor="math1"> MATH 101: College Algebra I </label>
          <br/>
        </div>
      <div className="form-check">
	  ...
	  <div className="form-check">
          ...
          <label class="form-check-label" htmlFor="bio1"> BIO 100: General Biology </label>
          <br/>
		  </div>
		  <div className="form-check">
          <input type="radio" class="form-check-input" id= "bio3"name="s2B"/>
          <label  class="form-check-label" htmlFor="zoo1"> BIO 103: General Plant Science </label>
		  <br/>
		  </div>
      <div className="form-check">
    ...
    <input type="radio" class="form-check-input" id="check1" name="option1" value="something" checked/>
      <label class="form-check-label" htmlFor="check1">LIFE 101: Life Skills I</label>
    </div>
    <div className="form-check">
      <input type="radio" class="form-check-input" id="check2" name="option2" value="something"/>
      <label class="form-check-label" htmlFor="check2">LIFE 102: Life Skills II (PREREQ: Life 101)</label>
    </div>
    <div className="form-check">
      <input type="radio" class="form-check-input" id="check2" name="option2" value="something"/>
      <label class="form-check-label" htmlFor="check2">LIFE 105: Social Skills (COREQ: Life 101)</label>
    </div>
      <p> Section 4: History</p>
      <div className="form-check">
          <input type="radio" class="form-check-input" id="chem1"name="s4"/>
          <label class="form-check-label" htmlFor="chem1"> HIST 100 and 101: World History </label>
          <br/>
        </div>
        <div className="form-check">
          <input type="radio" class="form-check-input"id="phys1" name="s4"/>
          <label class="form-check-label" htmlFor="phys1"> HIST 110 and 111: United States History </label>
          <br/>
        </div>
        <p> Section 5: Electives</p>
      <div className="form-check">
          <input type="checkbox" class="form-check-input" id="life103"name="s5"/>
          <label class="form-check-label" htmlFor="chem1">Life 103: Financial Skills (PREREQ: Life 101) </label>
          <br/>
        </div>
        <div className="form-check">
          <input type="checkbox" class="form-check-input"id="life104" name="s5"/>
          <label class="form-check-label" htmlFor="phys1"> Life 104: Cooking Skills (ADV: Life 101) </label>
          <br/>
        </div>
        <div className="form-check">
          <input type="checkbox" class="form-check-input"id="mus114" name="s5"/>
          <label class="form-check-label" htmlFor="phys1"> Mus 114: History of Rock and Roll </label>
          <br/>
        </div>
        <div className="form-check">
          <input type="checkbox" class="form-check-input"id="art100" name="s5"/>
          <label class="form-check-label" htmlFor="phys1"> Art 100: Art Essentials of Drawing </label>
          <br/>
        </div>
        <div className="form-check">
          <input type="checkbox" class="form-check-input"id="mus113" name="s5"/>
          <label class="form-check-label" htmlFor="phys1"> Mus 113: Survey of Rock and Roll </label>
<br/>
